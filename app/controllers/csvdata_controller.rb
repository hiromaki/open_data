...
class CsvdataController < ApplicationController
  ...
  def insert
    ...
    urls.push("http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_hinanbasyo.csv")
    # 防災関連施設ポイントデータ（災害時用へリポート）
    urls.push("http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_heliport.csv")
    # 防災関連施設ポイントデータ（防火水槽など）
    urls.push("http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_boukasuisou.csv")
    # 防災関連施設ポイントデータ（防災スピーカー）
    urls.push("http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_bousaisp.csv")
    # 防災関連施設ポイントデータ（津波避難ビル）
    urls.push("http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_hinanbiru.csv")
